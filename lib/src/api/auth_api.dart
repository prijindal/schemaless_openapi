...
class AuthApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [AppKeyVerifyResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AppKeyVerifyResponse>> verifyAppKey({ 
    ...
    AppKeyVerifyResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AppKeyVerifyResponse),
      ) as AppKeyVerifyResponse;
    ...
    return Response<AppKeyVerifyResponse>(
      data: _responseData,
