...
class LoginApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [GetInitializedResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetInitializedResponse>> getInitialized({ 
    ...
    final _path = r'/user/login/initialized';
    ...
    GetInitializedResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetInitializedResponse),
      ) as GetInitializedResponse;
    ...
    return Response<GetInitializedResponse>(
      data: _responseData,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<bool>> initializeServer({ 
    ...
    final _path = r'/user/login/initialize';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> loginUser({ 
    required UserLoginRequest userLoginRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  Future<Response<bool>> registerUser({ 
    ...
    final _path = r'/user/login/register';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
