...
class ApplicationAuthApi {

  final Dio _dio;

  final Serializers _serializers;

  const ApplicationAuthApi(this._dio, this._serializers);
  ...
  Future<Response<String>> generateKey({ 
    ...
    final _path = r'/application/auth/generatekey';
  ...
  Future<Response<String>> loginUser({ 
    ...
    try {
      const _type = FullType(ApplicationUserLoginRequest);
      _bodyData = _serializers.serialize(applicationUserLoginRequest, specifiedType: _type);
  ...
  Future<Response<RegisterUserResponse1>> registerUser({ 
    ...
    RegisterUserResponse1? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RegisterUserResponse1),
      ) as RegisterUserResponse1;
    ...
    return Response<RegisterUserResponse1>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<bool>> revokeKeys({ 
    ...
    final _path = r'/application/auth/revokekeys';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApplicationUserVerifyResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApplicationUserVerifyResponse>> verifyUserAuth({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/application/auth/verify';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ApplicationUserVerifyResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ApplicationUserVerifyResponse),
      ) as ApplicationUserVerifyResponse;
    ...
    return Response<ApplicationUserVerifyResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
